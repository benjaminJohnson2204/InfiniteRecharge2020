...
//  private double maxVerticalRatioOuter = hexagonCenterCanHitHeight / 2 / (Constants.ballRadius + Constants.ballTolerance);
    ...
    public void execute() {
        ...
        if ((Timer.getFPGATimestamp() - startTime) % 0.2 < 0.02) {
            ...
            xDistanceToInnerTarget = (Constants.targetXPosition - predictedPosition.getTranslation().getX()) == 0 ? 0.01 : Constants.targetXPosition - predictedPosition.getTranslation().getX();
