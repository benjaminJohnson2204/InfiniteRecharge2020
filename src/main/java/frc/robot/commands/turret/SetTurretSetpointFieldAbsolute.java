...
public class SetTurretSetpointFieldAbsolute extends CommandBase {
   ...
   *
   */
  public SetTurretSetpointFieldAbsolute(Turret turretSubsystem, DriveTrain driveTrainSubsystem, Vision visionSybsystem, Climber climber, DoubleSupplier xInput, DoubleSupplier yInput) {
